        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400">{t('facilities.subtitle')}</p>
                </div>
                <Button onClick={handleAddClick}>
                    <Plus className="mr-2 h-5 w-5" />
                    {t('facilities.add_button')}
                </Button>
            </div>
            ...
            <Card>
                <CardContent className="p-4 border-b border-slate-100 dark:border-slate-700 flex flex-col md:flex-row gap-4 justify-between items-center">
                    <form onSubmit={handleSearch} className="relative w-full max-sm:max-w-none max-w-sm">
                        <Input
