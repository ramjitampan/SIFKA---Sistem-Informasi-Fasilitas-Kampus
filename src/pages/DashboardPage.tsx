                ...
                <Card>
                    ...
                    <CardContent className="p-0">
                        <QueryStateHandler
                            ...
                            emptyState={{
                                icon: PackageOpen,
                                title: isStudent ? 'No reports yet' : t('common.no_data'),
                                description: isStudent ? 'You haven\'t submitted any reports yet.' : 'There are no recent reports to display.',
                                action: isStudent ? (
                                    <Link to="/reports/create">
                                        <Button variant="outline" size="sm">Submit New Report</Button>
                                    </Link>
                                ) : undefined
                            }}
                        >
